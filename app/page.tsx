    ...
    <>
      ...
      <div className={`${beVietnamPro.className} flex justify-center flex-col`}>
        <motion.div
          ...
          className="flex justify-center md:flex-row flex-col mt-40 w-[90vw] md:h-[50vh] md:pr-4 gap-6 border-b md:border-r border-[#FFFFFF2a] md:w-[85vw] ml-[5vw] md:ml-[10rem]"
        >
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            className="w-4/5 md:w-1/3 md:p-0 pb-12 font-light text-sm 2xl:text-lg text-[white]"
          >
            <h1>
        ...
        <motion.div
          ...
          className="md:w-[10vw] w-[20vw] ml-[5vw] md:ml-[10rem] h-[4px] bg-[#FFF]"
        ></motion.div>
      </div>
    </>
  );
